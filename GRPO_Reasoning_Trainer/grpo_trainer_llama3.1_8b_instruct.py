...
dataset_path = "datasets/train_grpo_data.jsonl"
# output_dir = "grpo_llama3.2_3b_trained_model"
...
# per_device_train_batch_size = 1 # User specified # A100: Can be much higher, e.g., 8, 16, or more
# gradient_accumulation_steps = 8 # User specified # A100: Adjust with per_device_train_batch_size
...
lora_config = LoraConfig(
    ...
    target_modules=[ # Common targets for Llama 3.1 models
        "q_proj",
        "k_proj",
        "v_proj",
        "o_proj",
...
training_args = GRPOConfig(
    output_dir="Llama-3.1-8B-Instruct-GRPO",
    learning_rate=1e-4, # Recommended LR for GRPO with LoRA
    ...
    max_prompt_length=512, # A100: Decreased from 1024
    max_completion_length=1024, # A100: Decreased from 2048
