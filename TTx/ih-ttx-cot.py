...
from utils.metric_utils import openai_llm_ttx_judge, openai_llm_ttx_v2_judge, load_gemini2_lm, load_gemini2_5_lm
import os
import random
...
output_filename = f"{current_datetime}_ttx_v2_{args.llm}_cot_nas_v2_combined_llm_judge.json" # Updated filename format
...
optimizedcot = tp.compile(TTxv2Module(), trainset=trainset_v2, num_trials=args.num_trials) # Use TTxModule
