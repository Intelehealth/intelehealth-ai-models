...
user_multiple_prompt = """Here is their case with the history of presenting illness, symptoms, their physical exams, and demographics.
        ...
        If there was a primary diagnosis is not "NA", mark further questions as "NA"
...
response = client.chat.completions.create(
    model="PrunaAI/OpenBioLLM-Llama3-70B-GGUF-smashed",
    messages=messages,
    response_format=multiple_diagnosis_schema,
    max_tokens=-1,
